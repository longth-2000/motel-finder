      ...
      <div id="notification">
        <div v-if="isRead">
          <div
            ...
            v-for="(noti, index) in notificationItems.filter(ele => ele.is_read === isRead)"
            :key="index"
          >
            <div id="box">
              <a-checkbox
        ...
        <div v-else>
          <div
            class="notify-content"
            v-for="(notify) in notificationItems.filter(ele => ele.is_read === isRead)"
            :key="notify.id"
          >
            <div id="box">
...
export default {
  ...
  watch: {
    notifications(val) {
      console.log('state', this.$store.state.user.userInfor._id)
      console.log('user', this.userInfor._id)
      if(val) {
        this.notificationItems = val.filter((item) => item.user_id == this.user._id)
      }
    },
    'user._id'(val) {
